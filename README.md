...
| [`backend`](plugins/backend) | A `code-reviewer` agent and a `backend-refactoring` skill for reviewing and refactoring backend changes on the current branch or a pull request. |
