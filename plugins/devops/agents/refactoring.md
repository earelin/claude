...
name: refactoring
description: >-
  Iteratively refactors the CI/CD pipeline and infrastructure-as-code a PR or branch adds
  or modifies, improving internal structure over small behaviour-preserving passes that keep
  ...
  refactor or clean up the pipeline or infrastructure code of a PR or branch without changing
  what it deploys or runs.
modelTier: default
permissionMode: auto
