...
name: refactoring
description: >-
  Iteratively refactors the frontend code a PR or branch adds or modifies, improving
  ...
  of a PR or branch without changing its behaviour.
modelTier: default
permissionMode: auto
